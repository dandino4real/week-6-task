...
export const validateUser = async function(name:string, email:string, password:string, confirmPassword: string, gender: string, phone: string, address: string, access_token: string){
    try {
